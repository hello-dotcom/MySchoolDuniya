                ...
                <div className="daterange-container">
                    <div className="date-range">
                        <div id="reportrange">
                            ...
                            <span className="range-text">Jun 11, 2019 - Jul 10, 2019</span>
                            <i className="fa fa-chevron-down arrow"></i>
                        </div>
                    </div>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="" className="download-reports" data-original-title="Download CSV">
