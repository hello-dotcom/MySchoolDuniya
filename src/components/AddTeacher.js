...
class AddTeacher extends Component{
    ...
    addFaculty=()=>{
        const {id,name,password,address,phone,email,qualification,subject,dob,role,parent_name,file}=this.state;
        ...
        return (
            <div className="container">
                   ...
                   <input
                    ...
                    <select id="role" name="role" required value={this.state.role}
                        onChange={this.handleChange}>
                    ...
                    <div className="btncontainer">
                        <button type="submit" onClick={()=>this.addFaculty()}>Add</button>
                    </div>  
            </div>  
